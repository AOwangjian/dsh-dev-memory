 ...
 */
export function mountDevMemoryRoutes(webServer, { getSnapshot, updateConfig, listWorkspaces, mutateWorkspace, openPath, getSessionAutoWrite, setSessionAutoWrite }) {
  const disposers = [
    webServer.register({
      kind: 'exact',
