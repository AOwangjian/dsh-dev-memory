...
const WRITE_PASS_INSTRUCTION = [
  ...
  'Prefer to update an existing memory file for that topic.',
  'Do not create a new sibling markdown file under the same module folder',
  '(for example fishing/case-8021-caocao-stage-fix-2026.md next to',
  'fishing/case-8021-caocao.md). Put later stages in the same file, or only then',
  'in a topic folder with README.md as the entry.',
