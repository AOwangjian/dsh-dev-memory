...
export const contract = {
  ...
  SERVICES: {
    ...
    CREDENTIALS: "credentials", // dsh-credentials: resolve/describe/set/unset without exposing values to UI
  },
  ...
  // ---- bundled dev-memory scripts: exact CLI ---------------------------------
  // Runtime defaults to this package's scripts/ directory; scriptsDir is explicit only.
  SCRIPTS: {
